    ...
    public class GameConfig : ScriptableObject
    {
        ...
        public static List<TrapDefinition> BuildDefaultTraps()
        {
            return new List<TrapDefinition>
            {
                ...
                MakeTrap("Yarn Ball", "Rolls around and grabs the cat's attention.", 1.5f, 3, new Color(0.91f, 0.42f, 0.57f)),
                MakeTrap("Toy Bird", "Chirps and hops to steal its attention.", 1.5f, 2, new Color(0.95f, 0.76f, 0.31f)),
                MakeTrap("Feather Wand", "Dances in the air and hypnotizes it.", 2f, 2, new Color(0.69f, 0.52f, 0.80f)),
                MakeTrap("Cardboard Box", "Irresistible - the cat just has to climb in.", 2f, 2, new Color(0.76f, 0.57f, 0.35f)),
                MakeTrap("Scratching Post", "It loves sharpening its claws here.", 2.5f, 1, new Color(0.85f, 0.70f, 0.35f)),
