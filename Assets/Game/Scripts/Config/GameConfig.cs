...
namespace MiceToBeHome
{
    ...
    public class GameConfig : ScriptableObject
    {
        ...
        public static List<TrapDefinition> BuildDefaultTraps()
        {
            ...
            {
                MakeTrap("Toy Mouse", "A quick, cheap decoy.", 1.5f, 3, new Color(0.60f, 0.63f, 0.65f)),
                MakeTrap("Yarn Ball", "Rolls around and grabs the cat's attention.", 2f, 3, new Color(0.91f, 0.42f, 0.57f)),
                MakeTrap("Toy Bird", "Chirps and hops to steal its attention.", 2.5f, 2, new Color(0.95f, 0.76f, 0.31f)),
                MakeTrap("Feather Wand", "Dances in the air and hypnotizes it.", 3f, 2, new Color(0.69f, 0.52f, 0.80f)),
                MakeTrap("Cardboard Box", "Irresistible - the cat just has to climb in.", 4f, 1, new Color(0.76f, 0.57f, 0.35f)),
                MakeTrap("Scratching Post", "It loves sharpening its claws here.", 5f, 1, new Color(0.85f, 0.70f, 0.35f)),
                MakeTrap("Tuna Can", "The smell keeps it busy for a good while.", 6f, 1, new Color(0.50f, 0.70f, 0.84f)),
                MakeTrap("Catnip", "Leaves it totally dazed - your panic button.", 7f, 1, new Color(0.50f, 0.69f, 0.41f))
            };
        }
